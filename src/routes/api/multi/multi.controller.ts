...
import type { RoomReserveInput, RoomSearchInput, RoomJoinInput, RoomCreateInput, RoomQuickInput, RoomGetInput, MemberInfoInput } from './multi.schema.js';
...
export const roomSearch = (req: Request, res: Response) => {
  const { auto_flag, kick, quest_id, quick_match, restart } = req.body as RoomSearchInput;
...
export const roomJoin = (req: Request, res: Response) => {
  const { auto_flag, kick, quest_id, quick_match, reserve, restart, room_id } = req.body as RoomJoinInput;
  const data = {
    rooms: {
      _id: '1',
      auto_flag: auto_flag,
...
export const roomQuick = (req: Request, res: Response) => {
  const { auto_flag, kick, name, quest_id, quick_match, reserve, restart, tag } = req.body as RoomQuickInput;
  const data = {
    rooms: {
      _id: '1',
      auto_flag: auto_flag,
...
export const roomGet = (req: Request, res: Response) => {
  const { quest_id, room_id } = req.body as RoomGetInput;
  const data = {
    check_join: 1,
    rooms: {
      _id: '1',
...
export const roomCreate = (req: Request, res: Response) => {
  const { auto_flag, kick, name, quest_id, quick_match, reserve, restart, tag } = req.body as RoomCreateInput;
  const data = {
    rooms: {
      _id: '0',
      auto_flag: auto_flag,
      created: 0, //fine
      host_id: 'sdsdsdsdsdsdsdsdsdsdsdsds',
      host_name: name.replace('の部屋', ''), //fine
      is_locked: 1, //fine
      kick: kick, //fine
      member_count: 1, //fine
      members: ['member'],
      name: name,
      phase: 7,
      quest_id: quest_id, //fine
      quick_match: quick_match, //fine
      reserve_members: reserve,
      restart: restart,
