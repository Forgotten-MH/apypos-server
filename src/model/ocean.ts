...
const _QUEST_STATE = {
  //0 =? 1 = New 2= ? 3= Clear (S A B C based on clear_time)
...
const NODE_STATE = {
  // State of node //0 = ?? 1 = ?? 2 = new! 3 = Medal and Silver Crown 4 = Medal and Gold Crown 5 = Bubble ... 6 = Help! 7 = Bubble with !  8= Bubble dancing around with music shape 9= Now to the next island sign
...
const PART_STATE = {
  // Part state (1 = Open, 0 = Closed 2 ==? 3== gingira_node like Sparkle over island)
  CLOSED: 0,
  OPEN: 1,
  UNKNOWN_2: 2,
